...
//!
//! NOT to be confused with [`crate::accounting::delegation`], which is a *different*
...
/// Count of snapshot-carried mandates [`crate::storage`]'s bulk-apply rejected
...
///
/// Rides inside a [`crate::record::ValidationRecord`] whose `creator_public_key`
...
/// A principal's revocation of a mandate. Rides in a [`crate::record::ValidationRecord`]
