...
> well under 60 s (virgin-join last re-proven **2026-07-26**: the mirror tree
> compiled standalone in 8m27s and the resulting binary reached
> root_local == root_authority `7efbc3c5…` at epoch 62562, **at-tip in 0.6 s**.
> Previously re-proven 2026-07-11 against the fresh post-re-genesis chain — the
> exact chain-replacing event this gate exists to catch — `64ff9e19…` at epoch
> 41669, at-tip in 19 s) — snapshot
