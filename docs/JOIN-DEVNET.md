...
> ~60 s (mirror build + virgin-join last re-verified 2026-06-30 vs epoch 26569,
> t_at_tip 60.8 s, repair_attempts=0 — re-confirmed after the WIRE_VERSION 0x02
> handshake-transcript binding, the exact fork-sensitive change this gate exists
> to catch) — snapshot
