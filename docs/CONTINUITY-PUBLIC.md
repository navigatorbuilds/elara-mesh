...
- **The history.** Every epoch of the development ledger is externally
  anchored (Bitcoin via OpenTimestamps, independent RFC 3161 authorities
  including an eIDAS-qualified one, drand randomness) — so ANY future fork or
