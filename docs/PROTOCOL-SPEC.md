...
binary seal `examples/verify/epoch-8219-zone-0.seal.wire` exercise the §6–§7 light
...
settlement-evidence path, and exactly the proof `elara-verify verify-inclusion`
...
seal — `examples/verify/epoch-8219-zone-0.seal.wire`, the very epoch the A.7
