...
(*     indefinitely" (epoch.rs:7359, cross_zone.rs:899) — so the real       *)
...
(*                        emitter try_sign_xzone_abort epoch.rs:7714). gst  *)
...
(* abstracts the BEST-EFFORT retry-on-next-tick emitter (epoch.rs:7362 uses *)
