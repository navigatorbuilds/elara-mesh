...
- **`elara_build_info` gauge** — operator-visible binary identity surface. Labels: `git_sha`, `git_ref`, `git_dirty`, `build_ts`. Fleet drift now detectable via single `curl /metrics` without ssh.
