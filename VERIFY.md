...
Every binary in an Elara GitHub Release (first tagged release: v0.2.x — until it is cut, build from source) carries two independent proofs you can
check before running anything. Neither requires trusting us — only the math and
publicly auditable infrastructure.
