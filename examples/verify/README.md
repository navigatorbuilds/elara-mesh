...
TIME BRACKET (seal 826306639200879b…):
  ...
  lower = drand round publication (BLS-verified — trustless); upper = Bitcoin block 957487 (archived header — pin-authenticated, trustless).
```

A **9-minute existence window**, proven offline against the drand beacon's math
and Bitcoin's proof-of-work — no Elara node consulted, nobody's word taken.
