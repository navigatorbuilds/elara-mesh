...
def main() -> int:
    ...
    print("Elara conformance — independent drand freshness (anchor not-before) verification (py_ecc BLS12-381)")
    ...
    print()
    print("ANCHOR-FRESHNESS NOT-BEFORE VERIFIED — independently, second toolchain (no Rust):")
