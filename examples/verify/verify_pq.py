...
Vectors checked (Appendix A.6 / A.8):
  ...
  * ``seal-anchor-sig``             — the light-client TRUST ROOT: a real
                                      anchor-signed epoch-8219 seal; verify the
...
def main() -> int:
    ...
    required = ["mldsa65-sig", "mldsa65-sig-reject",
                "seal-anchor-sig/epoch-8219-zone-0", "seal-anchor-sig-reject/wrong-anchor"]
    ...
    try:
        results = [
            ...
            _check_seal(oqs, vecs, "seal-anchor-sig/epoch-8219-zone-0"),
