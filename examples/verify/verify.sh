...
run "2. anchor — fully time-bracketed: a BLS-verified drand not-before below and a Bitcoin existed-by above, both proven offline (this sample is confirmed in block 957487; a still-pending anchor would exit 3, not 0)" \
